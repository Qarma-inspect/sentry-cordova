...
export function init(options) {
    ...
    const finalOptions = Object.assign(Object.assign(Object.assign({ enableAutoSessionTracking: true, enableWatchdogTerminationTracking: true }, DEFAULT_OPTIONS), { release: (_a = window === null || window === void 0 ? void 0 : window.SENTRY_RELEASE) === null || _a === void 0 ? void 0 : _a.id }), options);
